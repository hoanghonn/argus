...
from argus.chat.constant import answers_list
from argus.chat.models import QuizScore, QuizSession
from argus.chat.tasks import start_timer
    ...
    async def receive(self, text_data):
        ...
        if message_type == "answer-question":
            ...
            for answer in answers_list:
                if answer.get("question_id") == question_id:
                    if choice and choice == answer.get("correct_choice"):
                        response = "correct"
            current_score = await self.update_score(session_id, user_name, response)
            await self.send(
            ...
            activity_msg = {
                ...
                "message": f"{user_name} answer question {question_id} {response}ly.",
